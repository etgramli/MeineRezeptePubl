...
\begin{recipe}[
    ...
    source = Lili
]{Leinsamenbrötchen (Sonnenblumenkerne)}\index{Leinsamenbroetchen mit Sonnenblumenkernen@Leinsamenbrötchen mit Sonnenblumenkernen}\index{Brot!Leinsamenbrötchen mit Sonnenblumenkernen}
    \graph{
    ...
    \hint{%
        Aus {\unit[600]{ml}} Wasser und {\unit[4]{EL}} Natron zum Kochen bringen, die geformten Brötchen mit dem Schaumlöffel etwa 20~Minuten in der Lauge \gqq{baden}.
    }
\end{recipe}
\end{document}
